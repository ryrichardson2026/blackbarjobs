...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // Fetch Dallas security jobs
    const response = await fetch(
      'https://api.jobdatalake.com/v1/jobs?q=security+officer&location=Dallas&per_page=25&sort_by=posted_at:desc',
      {
        headers: {
    ...
    // Block companies with bad links
