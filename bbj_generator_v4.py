...
DFW_FOOTER = [
    ("/security-jobs-dfw",                 "DFW Security Jobs"),
    ("/jobs/security-officer-jobs-dallas", "Dallas Security Jobs"),
    ("/jobs/armed-security-dfw",           "Armed Security"),
    ("/jobs/unarmed-security-dfw",         "Unarmed Security"),
    ("/jobs/overnight-security-dfw",       "Overnight Security"),
    ("/jobs/event-security-dfw",           "Event Security"),
    ("/jobs/texas-security-license-requirements", "TX License Guide"),
]
HOUSTON_RESOURCES = [
...
DFW_RESOURCES = [
    ("/security-jobs-dfw",                      "DFW Security Jobs — Complete Guide"),
    ("/how-to-become-a-security-guard-in-texas","How To Become A Security Guard in Texas"),
    ("/security-guard-salary-texas",            "Texas Security Guard Salary Guide"),
